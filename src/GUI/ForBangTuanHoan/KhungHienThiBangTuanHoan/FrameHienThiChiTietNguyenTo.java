...
//	}
	...
	public FrameHienThiChiTietNguyenTo(int idNT) throws IOException, UnsupportedAudioFileException, LineUnavailableException {
		...
		content.setText("<html><body> <p style=\"font-size: 25px;line-height: 10px; margin: 0;padding: 0;\">" + 1
				+ "</p><p style=\"font-size: 25px;line-height: 10px;margin: 0;padding: 0;\"><b>H</b></p><p style=\"font-size: 22px;line-height: 10px;margin: 0;padding: 0;\">1,00794</p>\r\n"
				+ "</body></html>");
		...
		ElementDanhPhap dp = new ElementDanhPhap();
		dp.setBounds(0, 0, 650, 70);
		panel_1.add(dp);
		contentPane.add(panel_1);

		BufferedImage BufferImgNT = ImageIO.read(new File("asset//img//hydrogen.jpg"));
		Image imgNT = BufferImgNT.getScaledInstance(200, 200, Image.SCALE_SMOOTH);
		ImageIcon scalesNT = new ImageIcon(imgNT);
		JLabel lblNewLabel_1 = new JLabel(scalesNT);
		...
		panel_2.setBackground(new Color(216, 177, 177));
		panel_2.setBounds(223, 243, 442, 235);
		contentPane.add(panel_2);
		panel_2.setLayout(null);

		JLabel lblNewLabel_2 = new JLabel(
				"<html><body> <p>• Henry là người đầu tiên phân biệt được Hydrogen từ các khí khác.</p>\r\n" + "\r\n"
						+ "<p>• Nhà hóa học Pháp Antonie Lavoisier sau này đặt tên nguyên tố Hydrogen vào năm 1873.</p>\r\n"
						+ "\r\n" + "<p>• Hydrogen được sử dụng làm nhiên liệu cho tên lửa.</p>\r\n" + "\r\n"
						+ "<p>• Hydrogen thường được sử dụng trong các nhà máy điện làm chất làm mát trong máy phát điện.</p>\r\n"
						+ "\r\n"
						+ "<p>• Được sử dụng làm khí bảo vệ trong các phương pháp hàn như hàn Hydrogen nguyên tử.</p> </body></html>");
		lblNewLabel_2.setFont(new Font("Tahoma", Font.PLAIN, 18));
		lblNewLabel_2.setBounds(10, 0, 422, 235);
		...
		JLabel lblNewLabel_3 = new JLabel("<html><body>" + "<table>" + "  <tr>"
				...
				+ "    <td><font size=\"4\">Khí</font></td>" + "  </tr>" + "  <tr>"
				+ "    <td><font size=\"4\">Mật độ</font></td>"
				+ "    <td><font size=\"4\">0,00008988 g/cm<sup>3</sup></font></td>" + "  </tr>" + "  <tr>"
				+ "    <td><font size=\"4\">Nhiệt độ nóng chảy</font></td>"
				+ "    <td><font size=\"4\">14,01 K | -259,14 °C | -434,45 °F</font></td>" + "  </tr>" + "  <tr>"
				+ "    <td><font size=\"4\">Nhiệt độ sôi</font></td>"
				+ "    <td><font size=\"4\">20,28 K | -252,87 °C | -423,17 °F</font></td>" + "  </tr>" + "  <tr>"
				+ "    <td><font size=\"4\">Nhiệt lượng nóng chảy</font></td>"
				+ "    <td><font size=\"4\">0,558 kJ/mol</font></td>" + "  </tr>" + "  <tr>"
				+ "    <td><font size=\"4\">Nhiệt bay hơi</font></td>"
				+ "    <td><font size=\"4\">0,452 kJ/mol</font></td>" + "  </tr>" + "  <tr>"
				+ "    <td><font size=\"4\">Nhiệt dung</font></td>"
				+ "    <td><font size=\"4\">14,304 J/g·K</font></td>" + "  </tr>" + "</table>" + "</body></html>");
		...
		JLabel lbNameHoaHoc = new JLabel("Hidro");
