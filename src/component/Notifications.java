...
public class Notifications extends javax.swing.JComponent {
	...
	public Notifications(Frame frame, Type type, Location location, String message) {
//    	   this.fram = new Frame();
		this.fram = frame;
		this.type = type;
	...
	private void init(String message) {
		...
		String imagePath = "asset/img/logoHoaHoc.png";
		File imageFile = new File(imagePath);
		if (type == Type.SUCCESS) {
			lbIcon.setIcon(new javax.swing.ImageIcon("asset/img/sucess.png"));
			lbMessage.setText("Success");
		} else if (type == Type.INFO) {
			lbIcon.setIcon(new javax.swing.ImageIcon("asset/img/info.png"));
			lbMessage.setText("Info");
		} else {
			lbIcon.setIcon(new javax.swing.ImageIcon("asset/img/warning.png"));
	...
	private void initComponents() {
		...
		lbIcon.setIcon(new javax.swing.ImageIcon("asset/img/close.png")); // NOI18N
		...
		cmdClose.setIcon(new javax.swing.ImageIcon("asset/img/close.png")); // NOI18N
